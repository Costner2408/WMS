...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/untitled-1.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('css/untitled-2.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('css/untitled-3.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('css/untitled-4.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('css/untitled-5.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('css/untitled-6.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('css/untitled-7.css') }}">
...
<script src="{{ URL::asset('js/current-day.js') }}"></script>
</body>
