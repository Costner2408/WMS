    ...
    <section class="site-heading">
        <div class="container" id="contain">
            <div class="jumbotron" style="font-size: 23px;width: 813px;text-align: center;padding: 51px 32px;margin: -37px;margin-left: -75px;" id="jumbo"><span style="font-size: 18px;font-style: normal;font-weight: normal;font-family: Raleway, sans-serif;margin-top: 0;text-align: center;">WATERFLOW MONITORING SYSTEM</span>
                ...
                <form style="text-align: center;"><label id="label" style="font-size: 21px;">Username</label><input class="form-control" type="text" id="nama" name="nama"><label id="label" style="font-size: 21px;">Id Alat</label><input class="form-control" type="text" id="id" name="id"><label id="label">Alamat</label><input class="form-control" type="text" id="alamat" name="alamat"><label id="label">No.HP</label><input class="form-control" type="text" id="number" name="number"><label id="label">No.Rekening</label><input class="form-control" type="text" id="rek" name="rek"></form>
                <p style="text-align: center;"><a class="btn btn-primary" role="button" id="log-reg" style="text-align: center;width: 110.5469px;font-size: 18px;">update</a></p>
            </div>
        </div>
    </section>
    <footer>
